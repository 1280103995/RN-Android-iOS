...
public class ButtonM extends Button {
    ...
    public ButtonM(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (a != null) {
            //设置背景色
            ColorStateList colorList = a.getColorStateList(R.styleable.buttonM_bgColor);
            if (colorList != null) {
            ...
            //记录按钮被按下时的背景色
            ColorStateList colorListPress = a.getColorStateList(R.styleable.buttonM_bgColorPress);
            ...
            backGroundDrawable = a.getDrawable(R.styleable.buttonM_bgImage);
            if (backGroundDrawable != null){
                setBackgroundDrawable(backGroundDrawable);
            }
            //记录按钮被按下时的背景图片
            backGroundDrawablePress = a.getDrawable(R.styleable.buttonM_bgImagePress);
            //设置文字的颜色
    ...
    private boolean setTouchStyle(int state){
        if (state == MotionEvent.ACTION_DOWN) {
            ...
            if (backGroundDrawablePress != null) {
                setBackground(backGroundDrawablePress);
            }
